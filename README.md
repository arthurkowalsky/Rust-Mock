...
|----------|-------------|---------|
| `OPENAPI_FILE` | Path to OpenAPI specification file. When set, endpoints from the spec will be automatically imported on startup as dynamic endpoints. | `/app/openapi.json` |
